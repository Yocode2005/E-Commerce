...
const Footer = () => {
    ...
    const linkSections = [
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+91-810-796-0741", path: '/', icon: MailIcon },
                { text: "yogeshchhandhwal2005@gmail.com", path: '/', icon: PhoneIcon },
                { text: "302029,Jaipur,Rajasthan 302033", path: '/', icon: MapPinIcon }
            ]
        }
    ];
    ...
    const socialIcons = [
        ...
        { icon: InstagramIcon, link: "https://www.instagram.com/yo_chhandhwal_2005" },
        { icon: TwitterIcon, link: "https://twitter.com" },
        { icon: LinkedinIcon, link: "https://www.linkedin.com/in/yogesh-meena-/" },
    ]
